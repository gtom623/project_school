 ...
 */
 ...
 $languageGroups = include(__DIR__ . '/language_groups.php');


 Configure::write('LanguageGroups', $languageGroups);
 
 $genderGroups = include(__DIR__ . '/gender_groups.php');


 Configure::write('GenderGroups', $genderGroups);

 $availableClasses =  include(__DIR__ . '/school_classes.php');

 Configure::write('SchoolClasses', $availableClasses);
